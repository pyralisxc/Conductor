    ...
    if (req.method === 'POST') {
      try {
        ...
        if (values.get('action') === 'revoke') {
          ...
          message = 'Temporary owner exception revoked. Active work contexts still apply.';
